...
| **Component**                      |        **Summary**                   |
| ---------------------------------- | ----------------------------------| 
| ![esp](Microcon.webp)<br>Option 1.<br> ESP32-S3-WROOM-1-N4 <br>$5.06/each<br>[product link](https://www.digikey.com/en/products/detail/espressif-systems/ESP32-S3-WROOM-1-N4/16162639)       | \* Reason I chose this ESP is because of the abundance. We already had this component in class, so I was able to save a couple of bucks and already work with known footprints and measurements. We also had extensive lab testing with the ESP, so we had a good idea of how it worked.    |
| ![Option 1](Option10.webp)<br>Option 1.<br> LM2575D2T-3.3-ND1 <br>$1.08/each<br>[link to product](https://www.digikey.com/en/products/detail/onsemi/LM2575D2T-3-3R4/1476687)    | \* Same as above          |
