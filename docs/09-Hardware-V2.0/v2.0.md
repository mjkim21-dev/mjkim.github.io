...
## Files
To access the files, I have updated the original files to the [schematic](https://mjkim21-dev.github.io/mjkim21.github.io/06-Schematic/schematic/) and [PCB](https://mjkim21-dev.github.io/mjkim21.github.io/07-PCB/pcb/) sections. If you would like to reproduce this subsystem, please do not download "version 1". 
